...
def getLabeledData(imagefile, labelfile, picklename):
...
if __name__ == '__main__':
    ...
    print("Get testset")
    testing = getLabeledData('t10k-images-idx3-ubyte.gz',
                               't10k-labels-idx1-ubyte.gz', 'testing')
    print("Got %i testing datasets." % len(testing['x']))
    print("Get trainingset")
    training = getLabeledData('train-images-idx3-ubyte.gz',
