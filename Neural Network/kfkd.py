...
FTRAIN = '~/Documents/FacialFeatureDetection/training.csv'
FTEST = '~/Documents/FacialFeatureDetection/test.csv'
FLOOKUP = '~/Documents/FacialFeatureDetection/IdLookupTable.csv'
